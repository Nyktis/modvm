...
/**
 * offsetofend() - report the byte offset immediately after a struct field
 *
...
/* Volatile accesses that prevent compiler merging or refetching of this access.
 * These macros do not provide C atomic operations, inter-thread ordering, or
 * protection from data races. Use atomics or locks for thread synchronization.
 */
