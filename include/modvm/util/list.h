 ...
 * Note, that list is expected to be not empty.
 */
#define list_next_entry_circular(pos, head, member) (list_is_last(&pos->member, head) ? list_first_entry(head, __typeof__(*(pos)), member) : list_next_entry(pos, member))
 ...
 * Note, that list is expected to be not empty.
 */
#define list_prev_entry_circular(pos, head, member) (list_is_first(&pos->member, head) ? list_last_entry(head, __typeof__(*(pos)), member) : list_prev_entry(pos, member))
...
#define list_for_each_entry_reverse(pos, head, member) \
	for (pos = list_last_entry(head, __typeof__(*pos), member); !list_entry_is_head(pos, head, member); pos = list_prev_entry(pos, member))
...
#define list_for_each_entry_safe(pos, n, head, member)                                                                                         \
	for (pos = list_first_entry(head, __typeof__(*pos), member), n = list_next_entry(pos, member); !list_entry_is_head(pos, head, member); \
...
#define list_for_each_entry_safe_reverse(pos, n, head, member)                                                                                \
	for (pos = list_last_entry(head, __typeof__(*pos), member), n = list_prev_entry(pos, member); !list_entry_is_head(pos, head, member); \
 ...
 *
 * Removal with hlist_del_init() leaves the node unhashed; hlist_del()
 * leaves poisoned links and does not mark it unhashed.
 */
