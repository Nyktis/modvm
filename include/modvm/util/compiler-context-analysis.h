...
#define context_lock_struct(name, ...)                                                                                                                                           \
	...
	static __always_inline void __acquire_ctx_lock(const struct name *var) __attribute__((overloadable)) __no_context_analysis __acquires_ctx_lock(var)                      \
	{                                                                                                                                                                        \
	}                                                                                                                                                                        \
	static __always_inline void __acquire_shared_ctx_lock(const struct name *var) __attribute__((overloadable)) __no_context_analysis __acquires_shared_ctx_lock(var)        \
	{                                                                                                                                                                        \
	}                                                                                                                                                                        \
	static __always_inline bool __try_acquire_ctx_lock(const struct name *var, bool ret) __attribute__((overloadable)) __no_context_analysis __try_acquires_ctx_lock(1, var) \
	{                                                                                                                                                                        \
		return ret;                                                                                                                                                      \
	}                                                                                                                                                                        \
	...
	static __always_inline void __release_ctx_lock(const struct name *var) __attribute__((overloadable)) __no_context_analysis __releases_ctx_lock(var)                      \
	{                                                                                                                                                                        \
	}                                                                                                                                                                        \
	static __always_inline void __release_shared_ctx_lock(const struct name *var) __attribute__((overloadable)) __no_context_analysis __releases_shared_ctx_lock(var)        \
	{                                                                                                                                                                        \
	}                                                                                                                                                                        \
	static __always_inline void __assume_ctx_lock(const struct name *var) __attribute__((overloadable)) __assumes_ctx_lock(var)                                              \
	{                                                                                                                                                                        \
	}                                                                                                                                                                        \
	static __always_inline void __assume_shared_ctx_lock(const struct name *var) __attribute__((overloadable)) __assumes_shared_ctx_lock(var)                                \
	{                                                                                                                                                                        \
	}                                                                                                                                                                        \
	struct name
...
#define disable_context_analysis() \
	__diag_push();             \
	__diag_ignore_all("-Wunknown-warning-option", "") __diag_ignore_all("-Wthread-safety", "") __diag_ignore_all("-Wthread-safety-pointer", "")
 ...
 * function arguments.
 */
#define token_context_lock_instance(ctx, name) extern const struct __ctx_lock_##ctx *name
